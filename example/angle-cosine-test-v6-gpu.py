#!/usr/bin/env python3
"""
HOOMD-blue v6 test script for Cosine angle force on GPU
"""
import hoomd
import hoomd.md
import numpy as np
...
# File output
with open('status_gpu.txt', mode='w', newline='\n') as file:
    ...
    print(f"\n{'='*60}")
    print("HOOMD-blue v6 - Cosine Angle Force Test (GPU)")
    print(f"{'='*60}")
    ...
    print(f"Performance (TPS): {sim.tps:.2f}")
    print(f"{'='*60}\n")
